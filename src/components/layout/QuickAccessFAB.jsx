  ...
  return (
    <div className="fixed bottom-20 end-4 z-50 flex flex-col items-end gap-2">
      ...
      <motion.button
        ...
        className="w-14 h-14 rounded-full bg-zinc-950 text-accent flex items-center justify-center border-2 border-accent/65 hover:border-accent hover:bg-accent/10 transition-colors shadow-[0_0_15px_rgba(212,175,55,0.25)]"
