export default function GoldButton({
  ...
  const variants = {
    solid:
      'bg-accent hover:bg-accent-hover text-white dark:text-black shadow-[0_4px_15px_rgba(212,175,55,0.35)] hover:shadow-[0_8px_25px_rgba(212,175,55,0.4)]',
    outline:
      'bg-transparent border border-accent text-accent hover:bg-accent hover:text-white dark:hover:text-black',
