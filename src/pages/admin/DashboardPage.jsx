import { Users, Calendar, Shuffle, Clock, Swords } from 'lucide-react'
...
export default function DashboardPage() {
  ...
  const actions = [
    ...
    { label: t('knockout.dashboardLabel'), path: '/admin/knockout', icon: Swords, desc: t('knockout.dashboardDesc') },
  ]
