...
export default function TopScorersPage() {
  ...
  return (
    <div className="px-4 py-6 space-y-8">
      <div className="flex items-end justify-center gap-3 sm:gap-4 h-56 mb-4 mt-10">
        {podiumSlots.map(({ rank, scorer }, idx) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`w-full ${PODIUM_HEIGHTS[rank]} rounded-t-2xl flex flex-col items-center justify-end pb-3 px-1 mt-14 bg-gradient-to-t from-bg-surface to-bg-surface/60 border-t-2 ${
                  isFirst ? 'border-accent shadow-[0_0_24px_rgba(245,197,24,0.15)]' : 'border-border'
                }`}
              >
